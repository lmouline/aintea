 ...
 * @generated
 */
public class UMiniJavaDynamicDataSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public UMiniJavaDynamicDataSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UMiniJavaDynamicDataPackage.UBOOLEAN_VALUE: {
				UBooleanValue uBooleanValue = (UBooleanValue)theEObject;
				T result = caseUBooleanValue(uBooleanValue);
				if (result == null) result = caseBooleanValue(uBooleanValue);
				if (result == null) result = caseValue(uBooleanValue);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>UBoolean Value</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>UBoolean Value</em>'.
