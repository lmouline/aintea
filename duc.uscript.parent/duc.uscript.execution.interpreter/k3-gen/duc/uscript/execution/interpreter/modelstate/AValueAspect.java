...
public class AValueAspect {
  public static String convertToString(final Value _self) {
    ...
    if (_self instanceof duc.uscript.execution.Value){
    	result = duc.uscript.execution.interpreter.modelstate.AValueAspect._privk3_convertToString(_self_, (duc.uscript.execution.Value)_self);
    };
