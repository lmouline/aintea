...
public class DoubleConstantAspectDoubleConstantAspectContext {
  ...
  public static DoubleConstantAspectDoubleConstantAspectProperties getSelf(final DoubleConstant _self) {
    		if (!INSTANCE.map.containsKey(_self))
    			INSTANCE.map.put(_self, new duc.uscript.execution.interpreter.expression.DoubleConstantAspectDoubleConstantAspectProperties());
    		return INSTANCE.map.get(_self);
  }
  
  private Map<DoubleConstant, DoubleConstantAspectDoubleConstantAspectProperties> map = new java.util.WeakHashMap<duc.uscript.uScript.DoubleConstant, duc.uscript.execution.interpreter.expression.DoubleConstantAspectDoubleConstantAspectProperties>();
